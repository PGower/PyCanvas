...
class CourseQuizExtensionsAPI(BaseCanvasAPI):
    ...
    def set_extensions_for_student_quiz_submissions(self, user_id, course_id, extend_from_end_at=None, extend_from_now=None, extra_attempts=None, extra_time=None, manually_unlocked=None):
        ...
        * <b>403 Forbidden</b> if you are not allowed to extend quizzes for this course
        ...
        self.logger.debug("POST /api/v1/courses/{course_id}/quiz_extensions with payload: {payload}".format(payload=payload, **path))
        return self.generic_request("POST", "/api/v1/courses/{course_id}/quiz_extensions".format(**path), data=payload, no_data=True)
