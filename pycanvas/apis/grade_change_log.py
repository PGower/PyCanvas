...
class GradeChangeLogAPI(BaseCanvasAPI):
    ...
    def query_by_assignment(self, assignment_id, end_time=None, start_time=None):
        ...
        self.logger.debug("GET /api/v1/audit/grade_change/assignments/{assignment_id} with payload: {payload}".format(payload=payload, **path))
        return self.generic_request("GET", "/api/v1/audit/grade_change/assignments/{assignment_id}".format(**path), params=payload, all_pages=True)
    ...
    def query_by_course(self, course_id, end_time=None, start_time=None):
        ...
        self.logger.debug("GET /api/v1/audit/grade_change/courses/{course_id} with payload: {payload}".format(payload=payload, **path))
        return self.generic_request("GET", "/api/v1/audit/grade_change/courses/{course_id}".format(**path), params=payload, all_pages=True)
    ...
    def query_by_student(self, student_id, end_time=None, start_time=None):
        ...
        self.logger.debug("GET /api/v1/audit/grade_change/students/{student_id} with payload: {payload}".format(payload=payload, **path))
        return self.generic_request("GET", "/api/v1/audit/grade_change/students/{student_id}".format(**path), params=payload, all_pages=True)
    ...
    def query_by_grader(self, grader_id, end_time=None, start_time=None):
        ...
        self.logger.debug("GET /api/v1/audit/grade_change/graders/{grader_id} with payload: {payload}".format(payload=payload, **path))
        return self.generic_request("GET", "/api/v1/audit/grade_change/graders/{grader_id}".format(**path), params=payload, all_pages=True)
