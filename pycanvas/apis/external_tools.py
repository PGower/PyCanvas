...
class ExternalToolsAPI(BaseCanvasAPI):
    ...
    def list_external_tools_courses(self, course_id, search_term=None, selectable=None):
        ...
        self.logger.debug("GET /api/v1/courses/{course_id}/external_tools with payload: {payload}".format(payload=payload, **path))
        return self.generic_request("GET", "/api/v1/courses/{course_id}/external_tools".format(**path), params=payload, no_data=True)
    ...
    def list_external_tools_accounts(self, account_id, search_term=None, selectable=None):
        ...
        self.logger.debug("GET /api/v1/accounts/{account_id}/external_tools with payload: {payload}".format(payload=payload, **path))
        return self.generic_request("GET", "/api/v1/accounts/{account_id}/external_tools".format(**path), params=payload, no_data=True)
    ...
    def get_sessionless_launch_url_for_external_tool_courses(self, course_id, assignment_id=None, id=None, launch_type=None, url=None):
        ...
        if launch_type is not None:
            payload["launch_type"] = launch_type

        self.logger.debug("GET /api/v1/courses/{course_id}/external_tools/sessionless_launch with payload: {payload}".format(payload=payload, **path))
        return self.generic_request("GET", "/api/v1/courses/{course_id}/external_tools/sessionless_launch".format(**path), params=payload, no_data=True)
    ...
    def get_sessionless_launch_url_for_external_tool_accounts(self, account_id, assignment_id=None, id=None, launch_type=None, url=None):
        ...
        self.logger.debug("GET /api/v1/accounts/{account_id}/external_tools/sessionless_launch with payload: {payload}".format(payload=payload, **path))
        return self.generic_request("GET", "/api/v1/accounts/{account_id}/external_tools/sessionless_launch".format(**path), params=payload, no_data=True)
    ...
    def get_single_external_tool_courses(self, course_id, external_tool_id):
        ...
        self.logger.debug("GET /api/v1/courses/{course_id}/external_tools/{external_tool_id} with payload: {payload}".format(payload=payload, **path))
        return self.generic_request("GET", "/api/v1/courses/{course_id}/external_tools/{external_tool_id}".format(**path), params=payload, no_data=True)
    ...
    def get_single_external_tool_accounts(self, account_id, external_tool_id):
        ...
        self.logger.debug("GET /api/v1/accounts/{account_id}/external_tools/{external_tool_id} with payload: {payload}".format(payload=payload, **path))
        return self.generic_request("GET", "/api/v1/accounts/{account_id}/external_tools/{external_tool_id}".format(**path), params=payload, no_data=True)
    ...
    def create_external_tool_courses(self, name, course_id, consumer_key, privacy_level, shared_secret, account_navigation_enabled=None, account_navigation_text=None, account_navigation_url=None, config_type=None, config_url=None, config_xml=None, course_navigation_default=None, course_navigation_enabled=None, course_navigation_text=None, course_navigation_url=None, course_navigation_visibility=None, custom_fields=None, description=None, domain=None, editor_button_enabled=None, editor_button_icon_url=None, editor_button_selection_height=None, editor_button_selection_width=None, editor_button_url=None, icon_url=None, not_selectable=None, resource_selection_enabled=None, resource_selection_icon_url=None, resource_selection_selection_height=None, resource_selection_selection_width=None, resource_selection_url=None, text=None, url=None, user_navigation_enabled=None, user_navigation_text=None, user_navigation_url=None):
        ...
        if not_selectable is not None:
            payload["not_selectable"] = not_selectable
        ...
        if account_navigation_url is not None:
            payload["account_navigation[url]"] = account_navigation_url
        # OPTIONAL - account_navigation[enabled] - Set this to enable this feature
        if account_navigation_enabled is not None:
            payload["account_navigation[enabled]"] = account_navigation_enabled
        ...
        if course_navigation_text is not None:
            payload["course_navigation[text]"] = course_navigation_text
        ...
        if course_navigation_visibility is not None:
            payload["course_navigation[visibility]"] = course_navigation_visibility
        ...
        if editor_button_selection_width is not None:
            payload["editor_button[selection_width]"] = editor_button_selection_width
        ...
        if resource_selection_icon_url is not None:
            payload["resource_selection[icon_url]"] = resource_selection_icon_url
        ...
        if resource_selection_selection_width is not None:
            payload["resource_selection[selection_width]"] = resource_selection_selection_width
        ...
        if resource_selection_selection_height is not None:
            payload["resource_selection[selection_height]"] = resource_selection_selection_height
        ...
        self.logger.debug("POST /api/v1/courses/{course_id}/external_tools with payload: {payload}".format(payload=payload, **path))
        return self.generic_request("POST", "/api/v1/courses/{course_id}/external_tools".format(**path), data=payload, no_data=True)
    ...
    def create_external_tool_accounts(self, name, account_id, consumer_key, privacy_level, shared_secret, account_navigation_enabled=None, account_navigation_text=None, account_navigation_url=None, config_type=None, config_url=None, config_xml=None, course_navigation_default=None, course_navigation_enabled=None, course_navigation_text=None, course_navigation_url=None, course_navigation_visibility=None, custom_fields=None, description=None, domain=None, editor_button_enabled=None, editor_button_icon_url=None, editor_button_selection_height=None, editor_button_selection_width=None, editor_button_url=None, icon_url=None, not_selectable=None, resource_selection_enabled=None, resource_selection_icon_url=None, resource_selection_selection_height=None, resource_selection_selection_width=None, resource_selection_url=None, text=None, url=None, user_navigation_enabled=None, user_navigation_text=None, user_navigation_url=None):
        ...
        self.logger.debug("POST /api/v1/accounts/{account_id}/external_tools with payload: {payload}".format(payload=payload, **path))
        return self.generic_request("POST", "/api/v1/accounts/{account_id}/external_tools".format(**path), data=payload, no_data=True)
    ...
    def edit_external_tool_courses(self, course_id, external_tool_id):
        ...
        self.logger.debug("PUT /api/v1/courses/{course_id}/external_tools/{external_tool_id} with payload: {payload}".format(payload=payload, **path))
        return self.generic_request("PUT", "/api/v1/courses/{course_id}/external_tools/{external_tool_id}".format(**path), data=payload, no_data=True)
    ...
    def edit_external_tool_accounts(self, account_id, external_tool_id):
        ...
        self.logger.debug("PUT /api/v1/accounts/{account_id}/external_tools/{external_tool_id} with payload: {payload}".format(payload=payload, **path))
        return self.generic_request("PUT", "/api/v1/accounts/{account_id}/external_tools/{external_tool_id}".format(**path), data=payload, no_data=True)
    ...
    def delete_external_tool_courses(self, course_id, external_tool_id):
        ...
        self.logger.debug("DELETE /api/v1/courses/{course_id}/external_tools/{external_tool_id} with payload: {payload}".format(payload=payload, **path))
        return self.generic_request("DELETE", "/api/v1/courses/{course_id}/external_tools/{external_tool_id}".format(**path), params=payload, no_data=True)
    ...
    def delete_external_tool_accounts(self, account_id, external_tool_id):
        ...
        self.logger.debug("DELETE /api/v1/accounts/{account_id}/external_tools/{external_tool_id} with payload: {payload}".format(payload=payload, **path))
        return self.generic_request("DELETE", "/api/v1/accounts/{account_id}/external_tools/{external_tool_id}".format(**path), params=payload, no_data=True)
