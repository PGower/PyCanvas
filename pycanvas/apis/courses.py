...
class CoursesAPI(BaseCanvasAPI):
    ...
    def list_your_courses(self, enrollment_role=None, enrollment_role_id=None, enrollment_type=None, include=None, state=None):
        """
        List your courses.
...
class Course(BaseModel):
    ...
    def __init__(self, open_enrollment=None, storage_quota_used_mb=None, needs_grading_count=None, calendar=None, allow_wiki_comments=None, id=None, hide_final_grades=None, default_view=None, is_public_to_auth_users=None, root_account_id=None, end_at=None, storage_quota_mb=None, self_enrollment=None, permissions=None, start_at=None, account_id=None, workflow_state=None, public_syllabus=None, apply_assignment_group_weights=None, enrollment_term_id=None, course_format=None, enrollments=None, is_public=None, name=None, integration_id=None, term=None, syllabus_body=None, license=None, allow_student_forum_attachments=None, restrict_enrollments_to_course_dates=None, allow_student_assignment_edits=None, sis_course_id=None, course_progress=None, public_description=None, course_code=None, total_students=None):
