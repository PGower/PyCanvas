...
class RolesAPI(BaseCanvasAPI):
    ...
    def list_roles(self, account_id, show_inherited=None, state=None):
        ...
        if show_inherited is not None:
            payload["show_inherited"] = show_inherited

        self.logger.debug("GET /api/v1/accounts/{account_id}/roles with payload: {payload}".format(payload=payload, **path))
        return self.generic_request("GET", "/api/v1/accounts/{account_id}/roles".format(**path), params=payload, all_pages=True)
    ...
    def get_single_role(self, id, role_id, account_id, role=None):
        ...
        self.logger.debug("GET /api/v1/accounts/{account_id}/roles/{id} with payload: {payload}".format(payload=payload, **path))
        return self.generic_request("GET", "/api/v1/accounts/{account_id}/roles/{id}".format(**path), params=payload, single_item=True)
    ...
    def create_new_role(self, label, account_id, base_role_type=None, permissions_<X>_enabled=None, permissions_<X>_explicit=None, permissions_<X>_locked=None, role=None):
        ...
        if base_role_type is not None:
            payload["base_role_type"] = base_role_type
        # OPTIONAL - permissions[<X>][explicit] - no description
        if permissions_<X>_explicit is not None:
            payload["permissions[<X>][explicit]"] = permissions_<X>_explicit
        ...
        if permissions_<X>_enabled is not None:
            payload["permissions[<X>][enabled]"] = permissions_<X>_enabled
        ...
        if permissions_<X>_locked is not None:
            payload["permissions[<X>][locked]"] = permissions_<X>_locked

        self.logger.debug("POST /api/v1/accounts/{account_id}/roles with payload: {payload}".format(payload=payload, **path))
        return self.generic_request("POST", "/api/v1/accounts/{account_id}/roles".format(**path), data=payload, single_item=True)
    ...
    def deactivate_role(self, id, role_id, account_id, role=None):
        ...
        self.logger.debug("DELETE /api/v1/accounts/{account_id}/roles/{id} with payload: {payload}".format(payload=payload, **path))
        return self.generic_request("DELETE", "/api/v1/accounts/{account_id}/roles/{id}".format(**path), params=payload, single_item=True)
    ...
    def activate_role(self, id, role_id, account_id, role=None):
        ...
        self.logger.debug("POST /api/v1/accounts/{account_id}/roles/{id}/activate with payload: {payload}".format(payload=payload, **path))
        return self.generic_request("POST", "/api/v1/accounts/{account_id}/roles/{id}/activate".format(**path), data=payload, single_item=True)
    ...
    def update_role(self, id, account_id, label=None, permissions_<X>_enabled=None, permissions_<X>_explicit=None):
        ...
        * Any previously created custom role
        ...
        self.logger.debug("PUT /api/v1/accounts/{account_id}/roles/{id} with payload: {payload}".format(payload=payload, **path))
        return self.generic_request("PUT", "/api/v1/accounts/{account_id}/roles/{id}".format(**path), data=payload, single_item=True)
