...
class EnrollmentsAPI(BaseCanvasAPI):
    ...
    def list_enrollments_courses(self, course_id, role=None, state=None, type=None, user_id=None):
        ...
        self.logger.debug("GET /api/v1/courses/{course_id}/enrollments with payload: {payload}".format(payload=payload, **path))
        return self.generic_request("GET", "/api/v1/courses/{course_id}/enrollments".format(**path), params=payload, all_pages=True)
    ...
    def list_enrollments_sections(self, section_id, role=None, state=None, type=None, user_id=None):
        ...
        self.logger.debug("GET /api/v1/sections/{section_id}/enrollments with payload: {payload}".format(payload=payload, **path))
        return self.generic_request("GET", "/api/v1/sections/{section_id}/enrollments".format(**path), params=payload, all_pages=True)
    ...
    def list_enrollments_users(self, user_id, role=None, state=None, type=None):
        ...
        self.logger.debug("GET /api/v1/users/{user_id}/enrollments with payload: {payload}".format(payload=payload, **path))
        return self.generic_request("GET", "/api/v1/users/{user_id}/enrollments".format(**path), params=payload, all_pages=True)
    ...
    def enrollment_by_id(self, id, account_id):
        ...
        self.logger.debug("GET /api/v1/accounts/{account_id}/enrollments/{id} with payload: {payload}".format(payload=payload, **path))
        return self.generic_request("GET", "/api/v1/accounts/{account_id}/enrollments/{id}".format(**path), params=payload, single_item=True)
    ...
    def enroll_user_courses(self, course_id, enrollment_type, enrollment_user_id, enrollment_course_section_id=None, enrollment_enrollment_state=None, enrollment_limit_privileges_to_course_section=None, enrollment_notify=None, enrollment_role=None, enrollment_role_id=None, enrollment_self_enrolled=None, enrollment_self_enrollment_code=None):
        ...
        payload["enrollment[user_id]"] = enrollment_user_id
        ...
        if enrollment_enrollment_state is not None:
            payload["enrollment[enrollment_state]"] = enrollment_enrollment_state
        ...
        if enrollment_course_section_id is not None:
            payload["enrollment[course_section_id]"] = enrollment_course_section_id
        ...
        if enrollment_limit_privileges_to_course_section is not None:
            payload["enrollment[limit_privileges_to_course_section]"] = enrollment_limit_privileges_to_course_section
        ...
        if enrollment_notify is not None:
            payload["enrollment[notify]"] = enrollment_notify
        ...
        if enrollment_self_enrollment_code is not None:
            payload["enrollment[self_enrollment_code]"] = enrollment_self_enrollment_code
        ...
        if enrollment_self_enrolled is not None:
            payload["enrollment[self_enrolled]"] = enrollment_self_enrolled

        self.logger.debug("POST /api/v1/courses/{course_id}/enrollments with payload: {payload}".format(payload=payload, **path))
        return self.generic_request("POST", "/api/v1/courses/{course_id}/enrollments".format(**path), data=payload, single_item=True)
    ...
    def enroll_user_sections(self, section_id, enrollment_type, enrollment_user_id, enrollment_course_section_id=None, enrollment_enrollment_state=None, enrollment_limit_privileges_to_course_section=None, enrollment_notify=None, enrollment_role=None, enrollment_role_id=None, enrollment_self_enrolled=None, enrollment_self_enrollment_code=None):
        ...
        self.logger.debug("POST /api/v1/sections/{section_id}/enrollments with payload: {payload}".format(payload=payload, **path))
        return self.generic_request("POST", "/api/v1/sections/{section_id}/enrollments".format(**path), data=payload, single_item=True)
    ...
    def conclude_enrollment(self, id, course_id, task=None):
        ...
        self.logger.debug("DELETE /api/v1/courses/{course_id}/enrollments/{id} with payload: {payload}".format(payload=payload, **path))
        return self.generic_request("DELETE", "/api/v1/courses/{course_id}/enrollments/{id}".format(**path), params=payload, single_item=True)
