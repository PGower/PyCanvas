...
class QuizStatisticsQuestionStatistics(BaseModel):
    ...
    def __init__(self, responses=None, answers=None):
        """
        QuizStatisticsQuestionStatistics - a model defined in Swagger
    ...
    def responses(self):
        """
        Gets the responses of this QuizStatisticsQuestionStatistics.
        Number of students who have provided an answer to this question. Blank or empty responses are not counted.

        :return: The responses of this QuizStatisticsQuestionStatistics.
        :rtype: int
        """
    ...
    def responses(self, responses):
        ...
        :param responses: The responses of this QuizStatisticsQuestionStatistics.
        :type: int
        """
    ...
    def answers(self):
        """
        Gets the answers of this QuizStatisticsQuestionStatistics.
        Statistics related to each individual pre-defined answer.

        :return: The answers of this QuizStatisticsQuestionStatistics.
    ...
    def answers(self, answers):
        ...
        :param answers: The answers of this QuizStatisticsQuestionStatistics.
